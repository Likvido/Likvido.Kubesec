...
public static class CommandFactory
{
    ...
    {
        return new RootCommand("Kubernetes secret configuration helper")
        {
            CreatePullCommand(),
            CreatePushCommand(),
            CreateBackupCommand(),
    ...
    private static Command CreatePullCommand()
    {
        ...
        cmd.SetAction(async (parseResult, cancellationToken) =>
        {
            ...
            var validationError = PullCommand.Validate(configurePortForwarding, unwrapKeyName, jsonFieldsToDelete);
    ...
    private static Command CreateUpdateValueCommand()
    {
        var optionContext = new Option<string>("--context", "-c") { Description = "The kubectl config context to use" };
    ...
    private static async Task<int> TryCommandAsync(Func<Task<int>> command)
    {
        try
        {
