namespace Likvido.Kubesec
{
    ...
    public static class Program
    {
        ...
        private static Command CreateBackupCommand()
        {
            var optionContext = new Option<string>(new[] { "--context", "-c" }, "The kubectl config context to use");
            var optionNamespace = new Option<string>(new[] { "--namespace", "-n" }, "The namespace of services in kubernetes");
            var optionNamespaceIncludes = new Option<string>(new[] { "--namespace-includes", "-i" }, "The namespace keyword of services in kubernetes");
            var optionNamespaceRegex = new Option<string>(new[] { "--namespace-regex", "-rgx" }, "The namespace regex to search for services in kubernetes");
            ...
            cmd.SetHandler(
                ...
                {
                    InvocationContext!.ExitCode = TryCommand(() => BackupCommand.Run(context, @namespace, namespaceIncludes, namespaceRegex));
                },
